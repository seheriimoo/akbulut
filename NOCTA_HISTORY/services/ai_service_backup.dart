...
static String generateNoctaReply({
  ...
  if (step <= 1) {
    ...
    switch (state) {
      case SleepState.overthinking:
        return [
  "Tomorrow seems to be asking for a lot of your attention tonight.",
  "Part of your attention is still staying with tomorrow.",
  "Tomorrow appears to be taking up more space than it needs to right now.",
  "Your mind is still keeping a place open for tomorrow.",
  "It sounds like part of you is already living in tomorrow."
      ...
      case SleepState.workStress:
        ...
        return [
    "Part of your day still feels like it is following you here.",
    "Some of today still seems to be asking for your attention.",
    "It sounds like part of your mind is still staying with today's responsibilities.",
    "A piece of today may still feel unfinished tonight.",
    "Part of you is still carrying the weight of the day."
  ][DateTime.now().millisecond % 5];
      ...
      case SleepState.futureAnxiety:
        return [
          ...
          "Part of your attention already seems to be with the future.",
          "The future appears to be taking up more space than it needs to right now.",
          "Part of your mind may still be trying to get ahead of what comes next.",
          "Something about the future still seems to be asking for your attention."
        ][DateTime.now().millisecond % 5];
    ...
    switch (state) {
      ...
      case SleepState.futureAnxiety:
        return [
          ...
          "The future does not need to be figured out right now.",
          "Some uncertainty can remain unresolved for now.",
          "You do not need to know how everything will unfold tonight.",
          "Not everything about tomorrow needs to be decided right now."
        ][DateTime.now().millisecond % 5];
  ...
  switch (state) {
    case SleepState.overthinking:
      return [
  "You do not need to keep watch over it right now. For now, it can stay where it is.",
  "Nothing more is needed from you tonight.",
  "You have carried enough of it for today.",
  "You do not have to solve it before you rest.",
  "The night does not require an answer from you.",
  "For now, it is safe to leave it where it is.",
  "You can let go of it for a little while.",
  "You do not need to carry it any further tonight.",
  "For now, you can leave it where it is.",
  "The rest of it can wait outside this moment.",
  "You have done enough with it for one day.",
  "It does not need anything more from you tonight.",
  "You can stop holding it for a little while.",
  "For the next few minutes, it can simply stay unresolved.",
  "You do not have to stay with it right now.",
  "It is okay to leave the rest for tomorrow's version of you.",
  "You can let this moment be smaller than the thing you are carrying.",
  "For now, the weight of it can be set down.",
  "Nothing is asking anything more from you tonight.",
  ...
  "Tomorrow can stay where it is."
    ...
    case SleepState.futureAnxiety:
      return [
        "Not every answer needs to arrive tonight.",
        "The future can remain unfinished for now.",
        "You do not need to know how everything will unfold before you rest.",
        "Some things can stay uncertain until tomorrow.",
