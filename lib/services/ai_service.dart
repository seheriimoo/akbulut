...
class AIService {
  ...
  static RelationshipTheme detectRelationshipTheme(String input) {
    ...
    if (text.contains("talk to") || text.contains("one more time")) {
...
""",
  ...
  static String generateNoctaReply({
    ...
    if (stage == ConversationStage.observe) {
    ...
    if (stage == ConversationStage.understand) {
      switch (state) {
        case SleepState.overthinking:
          if (text.contains("debt") ||
              text.contains("loan") ||
        ...
        case SleepState.relationship:
          final relationshipTheme = detectRelationshipTheme(userInput);
